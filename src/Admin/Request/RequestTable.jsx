          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#E5E7EB] bg-gray-50">
                <th className="px-6 py-4 text-center text-sm font-medium text-gray-600">Request ID</th>
                <th className="px-6 py-4 text-center text-sm font-medium text-gray-600">Customer</th>
                <th className="px-6 py-4 text-center text-sm font-medium text-gray-600">Driver</th>
                <th className="px-6 py-4 text-center text-sm font-medium text-gray-600">Location</th>
                <th className="px-6 py-4 text-center text-sm font-medium text-gray-600">Time</th>
                ...
                requests.map((request) => (
                  ...
                  >
                    ...
                    <td className="flex items-center justify-center gap-2 px-6 py-4 text-sm">
                      <button className="rounded-lg bg-[#F3F4F6] hover:bg-[#e0dfdf] px-3 py-2 text-gray-900 text-sm font-medium">
                        View
                      </button>
                    </td>
                  </tr>
